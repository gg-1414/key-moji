...
class Hexagon extends Component {
  render() {
    ...
    return (
      <li>
        <div className={this.props.activateBtn ? "hexagon activateBtn" : "hexagon"} data-key={this.props.keyVal} onClick={(event) => {return this.props.activateKeyboard2 !== undefined ? this.props.activateKeyboard2(event) :
